#ifndef _H_TVM_CPP_ONNX_OP_SOFTMAX_PARSER_H_
#define _H_TVM_CPP_ONNX_OP_SOFTMAX_PARSER_H_
...
class SoftmaxParser : public IOnnxOpParser {
public:
    SoftmaxParser() = default;
    virtual ~SoftmaxParser() = default;
