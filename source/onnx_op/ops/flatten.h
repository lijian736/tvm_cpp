#ifndef _H_TVM_CPP_ONNX_OP_FLATTEN_PARSER_H_
#define _H_TVM_CPP_ONNX_OP_FLATTEN_PARSER_H_
...
class FlattenParser : public IOnnxOpParser {
public:
    FlattenParser() = default;
    virtual ~FlattenParser() = default;
