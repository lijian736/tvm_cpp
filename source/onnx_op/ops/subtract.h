#ifndef _H_TVM_CPP_ONNX_OP_SUBTRACT_PARSER_H_
#define _H_TVM_CPP_ONNX_OP_SUBTRACT_PARSER_H_
...
class SubtractParser : public IOnnxOpParser {
public:
    SubtractParser() = default;
    virtual ~SubtractParser() = default;
